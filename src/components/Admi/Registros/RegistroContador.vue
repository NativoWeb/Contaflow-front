        ...
        <div class="relative bg-white rounded-lg dark:bg-gray-800">
            ...
            <div class="p-8 text-center space-y-4">
                ...
                <p class="text-lg text-gray-700 dark:text-gray-300">
                    El usuario <strong>{{ userAccountant.first_name }}</strong> ha sido invitado a unirse a ContaFlow con el rol de Contador.
                </p>
                <p class="text-lg text-gray-700 dark:text-gray-300">
                    <img src="@/assets/correo.svg" alt="Correo" class="inline-block h-6 w-6 mr-3" />
                    Se ha enviado un correo a <strong>{{ userAccountant.username }}</strong> con un enlace de activación.
                </p>
            </div>
        </div>
    </div>
