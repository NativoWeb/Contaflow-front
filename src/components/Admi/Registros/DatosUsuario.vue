    ...
    <div class="w-full bg-white flex flex-col md:flex-row p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
            ...
            <div>
                ...
                <p class="text-left w-full bg-[#F5F5F5] border border-gray-300 rounded-full py-3 px-4">Juana</p>
            </div>
            <div>
                <label class="block uppercase tracking-wide text-[#193368] text-xs font-bold mb-2">
                    Apellidos:
      ...
      <form @submit.prevent="submitEdit">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p class="text-left w-full bg-gray-100 border border-gray-300 rounded-full py-2 px-3">Juana</p>
          </div>
          <div>
...
/* Cuando el tamaño de la pantalla es mayor a 768px (escritorio) */
@media (min-width: 768px) {
    .tables-container > div {
        width: 48%; /* Cada tabla ocupa el 48% del ancho, quedando 2 columnas */
    }
}
</style>
