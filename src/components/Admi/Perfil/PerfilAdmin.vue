  ...
  <section class="w-full bg-white shadow-md">
    ...
    <div class="w-full p-6">
      ...
      <div class="mt-4 flex flex-col gap-4 md:hidden">
        <button @click="router.push('/EditarPerfilAdmin')" class="w-full bg-[#08245B] hover:bg-[#2a4b8d] text-white font-bold py-3 px-4 rounded-full shadow-md shadow-gray-500/50 focus:outline-none focus:shadow-outline">
          Editar perfil
        </button>
        <button @click="router.push('/ContraseñaAdmin')" class="w-full bg-[#08245B] hover:bg-[#2a4b8d] text-white font-bold py-3 px-4 rounded-full shadow-md shadow-gray-500/50 focus:outline-none focus:shadow-outline">
          Cambiar contraseña
        </button>
      </div>
