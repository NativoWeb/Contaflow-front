    ...
    <form @submit.prevent="enviarFormulario" class="w-full">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div>
          ...
          <div class="relative">
            <select v-model="form.sector" class="w-full bg-[#F5F5F5] border border-gray-300 text-[#08245B] py-3 px-4 rounded-full focus:outline-none focus:bg-white focus:border-gray-500">
