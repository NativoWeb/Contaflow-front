    ...
    <div class="p-4 flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
      ...
      <div class="w-full md:w-1/2">
        ...
        <div class="flex items-center bg-gray-50 border border-[#B4C3DF] rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-600">
          ...
          <input type="text"  v-model="searchQuery" id="table-search-reportes" placeholder="Buscar..."
...
router.push({ name: 'ListaReporte', query: { nit: empresa.nit, razonSocial: empresa.razonSocial, direccion: empresa.direccion, sectorEconomico: empresa.sectorEconomico } });
};
