<template>
  <div class="p-6 flex flex-col w-full h-full ">
    <!-- Título -->
    <h2 class="text-xl font-bold bg-gradient-to-r from-[#F8F8F8] to-[#E5EAFF] text-[#193368] p-4 text-center md:text-left" style="border-radius: 8px 8px 0 0;">
      Reporte de Conciliación Bancaria y Contable
    </h2>

    <!-- Contenedor de búsqueda y selección de empresa -->
    <div class="p-4 bg-[#FBFBFB] flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0">
    ...
    <!-- Tabla -->
    <div class="overflow-x-auto p-4 bg-[#FBFBFB]" >
