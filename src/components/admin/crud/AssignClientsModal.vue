<template>
  ...
  <div v-if="showModal" tabindex="-1" class="fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
    <div class="w-[70%] h-[90%] m-auto relative p-4">
      <div class="relative bg-white rounded-lg dark:bg-gray-700 w-[100%] h-[100%] p-8">
        ...
        <div class="relative overflow-x-auto p-4 max-h-[calc(100%-150px)] overflow-y-auto">
